...
$sql = "SELECT image, product_id, product_name, product_desc, price, author, stock FROM products WHERE category = 'romance'";
...
<html lang="pt">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>Romances - Livraria Magic Book</title>
    ...
    <style>
    body {
        background: url(../Src/Images/bg_heart.jpg);
    }
    .img-book {
    width: 200px; 
    height: 260px; 
...
<main>
    <section class="py-3 text-center container">
        <div class="row py-lg-2">
            <div class="col-lg-6 col-md-8 mx-auto" style="background-color:white; opacity:0.8;">
                <h1 class="fw-light">LOVE IS IN THE AIR</h1>
                <p class="lead text-body-secondary">Gosta de um bom romance? Conheça nossa coleção abaixo!</p>
            </div>
        </div>
    </section>
