...
$sql = "SELECT image, product_id, product_name, product_desc, price, author, stock FROM products WHERE category = 'humor'";
...
<html lang="pt">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>Humor - Livraria Magic Book</title>
    ...
    <style>
    body {
        background: url(../Src/Images/humor.jpg);
    }
    .img-book {
    width: 200px; 
    height: 260px; 
    ...
    <section class="py-3 text-center container">
        <div class="row py-lg-2">
            <div class="col-lg-6 col-md-8 mx-auto" style="background-color:white; opacity:0.8;">
                <h1 class="fw-light">MORRER? SÓ SE FOR DE RIR!</h1>
                <p class="lead text-body-secondary">Nossa coleção é de cair na gargalhada!</p>
            </div>
        </div>
    </section>
