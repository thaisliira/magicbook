...
$sql = "SELECT image, product_id, product_name, product_desc, price, author, stock FROM products WHERE category = 'biografia'";
...
<html lang="pt">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>Biografias - Livraria Magic Book</title>
    ...
    <style>
    body {
        background: url(../Src/Images/biografia.jpg);
    }
    .img-book {
    width: 200px; 
    height: 260px; 
    ...
    <section class="py-3 text-center container">
        <div class="row py-lg-2">
            <div class="col-lg-8 col-md-8 mx-auto" style="background-color:white; opacity:0.8;">
                <h1 class="fw-light">Biografias</h1>
                <p class="lead text-body-secondary">As mais procuradas, encontras aqui.</p>
            </div>
        </div>
    </section>
